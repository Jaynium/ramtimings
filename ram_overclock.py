...
class RAMOverclockGame:
    ...
    def choose_memory_kit(self):
        kits = [
            # DDR4 Kits
            MemoryModule("Pirate Revenge LPX 3200", MemoryType.DDR4, MemoryIC.HYNIX_CJR, 
                        2133, (15, 15, 15, 36), 3200, (16, 18, 18, 36), 1.35, 16, 35.0, 6),
            MemoryModule("GameSkill Blade Z Neo 3600", MemoryType.DDR4, MemoryIC.SAMSUNG_CDIE,
                        2133, (15, 15, 15, 36), 3600, (16, 19, 19, 39), 1.35, 16, 38.0, 7),
            MemoryModule("GameSkill Blade Z Elite 4000", MemoryType.DDR4, MemoryIC.SAMSUNG_BDIE,
                        2133, (15, 15, 15, 36), 4000, (19, 19, 19, 39), 1.4, 16, 40.0, 9),
            MemoryModule("Essential Tactical 3200", MemoryType.DDR4, MemoryIC.MICRON_EDIE,
                        2133, (15, 15, 15, 36), 3200, (16, 18, 18, 36), 1.35, 16, 36.0, 7),
            MemoryModule("Squad Power Xtreme 4500", MemoryType.DDR4, MemoryIC.SAMSUNG_BDIE,
                        2133, (15, 15, 15, 36), 4500, (19, 19, 19, 39), 1.45, 16, 42.0, 10),
            MemoryModule("Royal Rage Monster 3600", MemoryType.DDR4, MemoryIC.HYNIX_DJR,
                        2133, (15, 15, 15, 36), 3600, (18, 22, 22, 42), 1.35, 16, 37.0, 6),
            MemoryModule("Freedom Snake Steel 4400", MemoryType.DDR4, MemoryIC.SAMSUNG_BDIE,
                        2133, (15, 15, 15, 36), 4400, (19, 19, 19, 39), 1.45, 16, 41.0, 9),
            MemoryModule("Pirate Revenge RGB Pro 3600", MemoryType.DDR4, MemoryIC.SAMSUNG_CDIE,
                        2133, (15, 15, 15, 36), 3600, (18, 22, 22, 42), 1.35, 16, 38.0, 7),
            MemoryModule("Alpha Prime Matrix D60G 3600", MemoryType.DDR4, MemoryIC.HYNIX_CJR,
                        2133, (15, 15, 15, 36), 3600, (18, 20, 20, 40), 1.35, 16, 38.0, 6),
            MemoryModule("HeatMax STRONGRAM RGB 3200", MemoryType.DDR4, MemoryIC.SAMSUNG_CDIE,
                        2133, (15, 15, 15, 36), 3200, (16, 18, 18, 36), 1.35, 16, 36.0, 6),
            # DDR5 Kits
            MemoryModule("Pirate Supreme Platinum 5200", MemoryType.DDR5, MemoryIC.MICRON_BDIE,
                        4800, (40, 40, 40, 76), 5200, (40, 40, 40, 76), 1.25, 32, 42.0, 8),
            MemoryModule("GameSkill Blade Z5 RGB 6000", MemoryType.DDR5, MemoryIC.SAMSUNG_EDIE,
                        4800, (40, 40, 40, 76), 6000, (30, 38, 38, 96), 1.35, 32, 45.0, 9),
            MemoryModule("Royal Rage Monster 5600", MemoryType.DDR5, MemoryIC.MICRON_BDIE,
                        4800, (40, 40, 40, 76), 5600, (36, 36, 36, 76), 1.25, 32, 43.0, 7),
            MemoryModule("Pirate Revenge DDR5 5600", MemoryType.DDR5, MemoryIC.HYNIX_MFR,
                        4800, (40, 40, 40, 76), 5600, (36, 36, 36, 76), 1.25, 32, 43.0, 7),
            MemoryModule("Squad Power Delta RGB 6200", MemoryType.DDR5, MemoryIC.SAMSUNG_EDIE,
                        4800, (40, 40, 40, 76), 6200, (36, 36, 36, 76), 1.35, 32, 46.0, 8),
            MemoryModule("Alpha Prime Spear RGB 6000", MemoryType.DDR5, MemoryIC.MICRON_BDIE,
                        4800, (40, 40, 40, 76), 6000, (32, 38, 38, 96), 1.35, 32, 45.0, 8),
            MemoryModule("Essential DDR5 5200", MemoryType.DDR5, MemoryIC.MICRON_BDIE,
                        4800, (40, 40, 40, 76), 5200, (42, 42, 42, 84), 1.1, 32, 40.0, 6),
            MemoryModule("Freedom Snake Poison DDR5 6200", MemoryType.DDR5, MemoryIC.SAMSUNG_EDIE,
                        4800, (40, 40, 40, 76), 6200, (36, 36, 36, 76), 1.35, 32, 46.0, 9),
            MemoryModule("HeatMax STRONGRAM RC DDR5 5600", MemoryType.DDR5, MemoryIC.HYNIX_MFR,
                        4800, (40, 40, 40, 76), 5600, (36, 36, 36, 76), 1.25, 32, 43.0, 7),
            MemoryModule("GameSkill Blade Z5 Elite 6400", MemoryType.DDR5, MemoryIC.SAMSUNG_EDIE,
    ...
    def choose_memory_controller(self):
        controllers = [
            ("Blue Chip Z690/Z790 IMC", MemoryController(7, 1.5, True, True, 2, 1, 1.1, 1.25)),
            ("Red Stone Zen 3 IMC", MemoryController(6, 1.45, False, False, 1, 1, 0.9, 1.0)),
            ("Blue Chip Z490/Z590 IMC", MemoryController(8, 1.55, True, True, 2, 1, 1.15, 1.3)),
            ("Red Stone Zen 4 IMC", MemoryController(8, 1.4, True, True, 1, 1, 0.95, 1.05)),
        ]
